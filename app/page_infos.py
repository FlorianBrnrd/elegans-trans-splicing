...
def show_abstract():
    ...
    abstract = 'Nematode mRNA processing involves a trans-splicing step through which a 21bp sequenced ' \
               ...
               'share the capacity to generate a 5’ terminal hairpin structure mimicking the SL structure providing ' \
               'mechanistic explanation for their non conformity. Altogether, our data provides the most ' \
               'a comprehensive quantitative analysis of SL usage to date in *C. elegans*.'
